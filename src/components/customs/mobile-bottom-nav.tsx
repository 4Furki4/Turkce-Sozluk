            ...
            <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-lg border-t border-border pb-[env(safe-area-inset-bottom)]">
                <div className="grid grid-cols-5 items-center h-16 px-2">
                    {navItems.map((item, index) => {
                        ...
                        return (
                            ...
                            >
                                <Icon
                                    className={cn(
                                        "w-6 h-6 mb-1 max-[420px]:mb-0 transition-all",
                    ...
                    <button
                        ...
                        className="flex flex-col items-center justify-center p-2 rounded-md text-muted-foreground hover:text-foreground transition-all duration-200"
                        aria-label={ariaMenu}
                    >
