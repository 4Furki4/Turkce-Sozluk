...
export const RawDataViewer: FC<RawDataViewerProps> = ({ data }) => {
  ...
  return (
    <details className="mt-4 p-4 bg-gray-100 dark:bg-gray-800 rounded-sm">
      <summary className="cursor-pointer font-semibold text-gray-700 dark:text-gray-300">
        {t('viewRawData')}
      </summary>
      <pre className="mt-2 p-2 bg-gray-200 dark:bg-gray-900 rounded-sm overflow-auto text-sm text-gray-800 dark:text-gray-200">
