                ...
                <CustomCard isBlurred={isBlurEnabled} className="md:col-span-1 h-full transition-colors">
                    ...
                    <CardBody className="pt-0">
                        <div className="grid grid-cols-2 gap-3 h-full content-center">
                            <div className="p-3 bg-zinc-500/10 rounded-sm border border-zinc-500/20 flex flex-col items-center justify-center gap-1 group hover:bg-zinc-500/20 transition-colors">
                                <p className="text-2xl font-bold text-foreground">{totalPoints}</p>
                                <p className="text-xs text-muted-foreground text-center line-clamp-1">{t('totalContributionPointsLabel')}</p>
                            </div>
                            <div className="p-3 bg-green-500/10 rounded-sm border border-green-500/20 flex flex-col items-center justify-center gap-1 group hover:bg-green-500/20 transition-colors">
                            ...
                            <div className="p-3 bg-yellow-500/10 rounded-sm border border-yellow-500/20 flex flex-col items-center justify-center gap-1 group hover:bg-yellow-500/20 transition-colors">
                                <div className="flex items-center gap-1">
                            ...
                            <div className="p-3 bg-red-500/10 rounded-sm border border-red-500/20 flex flex-col items-center justify-center gap-1 group hover:bg-red-500/20 transition-colors">
                                <div className="flex items-center gap-1">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                            {(profileData as any).badges?.map((badge: any) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className={`flex flex-col items-center justify-center p-4 rounded-sm border transition-all duration-200 hover:scale-105 cursor-help ${badge.earned ? 'bg-primary/10 border-primary/20' : 'bg-muted/50 border-muted grayscale opacity-60'}`}>
                                    ...
                                    {savedWordsToRender.map((savedWord) => (
                                        <li key={savedWord.wordId}>
                                            <NextIntlLink href={{ pathname: '/search/[word]', params: { word: savedWord.wordName } }} className="block w-full text-left">
                                                <div className="p-3 bg-zinc-500/5 hover:bg-zinc-500/10 rounded-sm border border-transparent hover:border-zinc-500/20 transition-all duration-200 group">
                                    ...
                                    return (
                                        <li key={contribution.id}>
                                            <NextIntlLink className='block w-full' href={{
                                                ...
                                                <div className="p-3 bg-zinc-500/5 hover:bg-zinc-500/10 rounded-sm border border-transparent hover:border-zinc-500/20 transition-all duration-200 group flex items-center justify-between gap-4">
