      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        {searchHistory?.map((item, index) => (
          <Link
            ...
            className="group relative flex flex-col justify-between p-4 bg-background/60 border border-border rounded-md hover:bg-background/90 hover:border-border transition-all duration-300"
          >
